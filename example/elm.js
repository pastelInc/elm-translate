...
var _user$project$Translate$Leaf = function (a) {
	return {ctor: 'Leaf', _0: a};
};
var _user$project$Translate$Branch = function (a) {
	return {ctor: 'Branch', _0: a};
};
var _user$project$Translate$treeDecoder = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A2(_elm_lang$core$Json_Decode$map, _user$project$Translate$Leaf, _elm_lang$core$Json_Decode$string),
		_1: {
			ctor: '::',
			_0: _elm_lang$core$Json_Decode$lazy(
				function (_p15) {
					return A2(
						...
						_elm_lang$core$Json_Decode$dict(_user$project$Translate$treeDecoder));
				}),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Translate$decode = A2(_elm_lang$core$Json_Decode$map, _user$project$Translate$mapTreeToDict, _user$project$Translate$treeDecoder);
var _user$project$Translate$request = function (url) {
	return A2(_elm_lang$http$Http$get, url, _user$project$Translate$decode);
};
var _user$project$Translate$fetchTranslations = F2(
	function (msg, url) {
		return A2(
			_elm_lang$http$Http$send,
			msg,
			_user$project$Translate$request(url));
	});
	...
	if (_p0.ctor === 'Loading') {
		...
		return _elm_lang$html$Html$text(
			A3(
				...
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'name', _1: 'Chihaya'},
					_1: {ctor: '[]'}
				},
				_p2));
	}
...
var _user$project$Main$updateTranslations = F2(
	function (msg, model) {
		var _p3 = model;
		if (_p3.ctor === 'Loading') {
			return A2(
				...
				_user$project$Main$Loaded(
					A2(_user$project$Translate$update, msg, _p3._0)),
				{
					ctor: '::',
...
var _user$project$Main$ChangeTranslations = function (a) {
	return {ctor: 'ChangeTranslations', _0: a};
};
var _user$project$Main$UpdateTranslations = function (a) {
...
var _user$project$Main$init = function (_p4) {
	...
	var ln = A2(
		...
		'',
		A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, _p5.language));
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_user$project$Main$Loading(
			_user$project$Translate$init(ln)),
		{
			ctor: '::',
			_0: A2(
				_elm_lang$core$Platform_Cmd$map,
				_user$project$Main$UpdateTranslations,
				_user$project$Translate$loadTranslations(url)),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p6 = msg;
		if (_p6.ctor === 'UpdateTranslations') {
			return A2(_user$project$Main$updateTranslations, _p6._0, model);
		} else {
			var url = A2(
				_elm_lang$core$String$join,
				'',
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'language', _elm_lang$core$Json_Decode$value)));
